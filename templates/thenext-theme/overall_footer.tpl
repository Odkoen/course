        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-12">
                    ...
                    <p> Зар, сурталчилгааны платформ </p>
                </div>
                    ...
                    <div class="footer-rows-right">
                        <div class="footer-row">
                            <ul class="footer-social-links">
                                IF('{FACEBOOK_LINK}'!=""){
                                <li><a href="{FACEBOOK}" target="_blank"><i class="la la-facebook"></i></a></li>
                                {:IF}
                                IF('{TWITTER_LINK}'!=""){
                                <li><a href="{TWITTER}" target="_blank"><i class="la la-twitter"></i></a></li>
                                {:IF}
                                IF('{GOOGLEPLUS_LINK}'!=""){
                                <li><a href="{GOOGLEPLUS}" target="_blank"><i class="la la-pinterest"></i></a></li>
                                {:IF}
                                IF('{YOUTUBE_LINK}'!=""){
                                <li><a href="{YOUTUBE}" target="_blank"><i class="la la-youtube-play"></i></a></li>
                                {:IF}
                            </ul>
