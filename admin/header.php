                ...
                <nav class="drawer-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav">
                            <a href="#"><i class="ion-image"></i> Зарууд </a>
                            <ul class="nav nav-subnav">
                                <li><a href="post_active.php">Идэвхитэй зар</a></li>
                                ...
                                <li><a href="posts.php">Бүх зар </a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-has-subnav">
                        ...
                        <li class="nav-item">
                            <a href="logout.php"><i class="ion-ios-people-outline"></i> Гарах</a>
                        </li>
                    </ul>
                </nav>
