...
<head>
    ...
    <!-- Document title -->
    <title><?php echo $config['site_title']?> - Нэвтрэх хэсэг</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="card" id="admin_login_card">
                                <h3 class="card-header h4">Нэвтрэх</h3>
                                <div class="card-block">
                                    ...
                                    <form action="#" method="post">
                                        <div class="form-group">
                                            <label class="sr-only" for="username">Имэйл</label>
                                            <input type="text" name="username" class="form-control" id="username" placeholder="Нэвтрэх нэр" />
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="login_password">Нууц үг</label>
                                            <input type="password" name="password" class="form-control" id="login_password" placeholder="Нууц үг" />
                                        </div>
                                        <?php
                                        if($config['recaptcha_mode']== 1){
                                            ?>
                                        ...
                                        <div class="form-group">
                                            <label for="frontend_login_remember" class="css-input switch switch-sm switch-app">
                                                <input type="checkbox" id="frontend_login_remember" /><span></span> Намайг сана</a>
                                            </label>
                                        </div>
                                        <button type="submit" class="btn btn-app btn-block" name="login">Нэвтрэх</button>
                                    </form>
                                </div>
                                <!-- .card-block -->
                            </div>
